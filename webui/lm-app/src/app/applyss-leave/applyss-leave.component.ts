...
@Component({
  selector: 'app-applyss-leave',
  templateUrl: './applyss-leave.component.html',
  styleUrls: ['./applyss-leave.component.css']
})
export class ApplyssLeaveComponent implements OnInit {
...
applyLeave(form: NgForm)
{
  // alert("Hi");
   ...
   //     alert("Invalid");
    ...
    this.leavedetailsService.applyssLeave(this.model,this.empId).subscribe(
        success => {
            this.msg=success;
